...
/* harmony import */ var _utils_remove_nojs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./utils/remove-nojs */ "./js/utils/remove-nojs.js");
...
/* harmony import */ var _modules_send_form__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/send-form */ "./js/modules/send-form.js");
/* harmony import */ var _modules_map_create_script__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/map/create-script */ "./js/modules/map/create-script.js");
/* harmony import */ var _modules_map_lazy_load_map__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/map/lazy-load-map */ "./js/modules/map/lazy-load-map.js");
...
window.addEventListener('DOMContentLoaded', function () {
  Object(_utils_remove_nojs__WEBPACK_IMPORTED_MODULE_2__["resetDefaultClass"])();
  ...
  window.addEventListener('load', function () {
    ...
    Object(_modules_send_form__WEBPACK_IMPORTED_MODULE_5__["initForm"])();
    _modules_map_lazy_load_map__WEBPACK_IMPORTED_MODULE_7__["observer"].observe(_modules_map_lazy_load_map__WEBPACK_IMPORTED_MODULE_7__["target"]);
  });
});
...
var burgerBtn = header.querySelector('[data-header="burger-button"]');
var logo = header.querySelector('[data-header="logo"]');
var burgerNav = header.querySelector('[data-header="nav"]');
var burgerLink = header.querySelectorAll('[data-header="nav-link"]');
function handleBurger() {
  if (body.clientWidth >= 768) {
    return;
  }
  html.scrollLock = new _utils_scroll_lock__WEBPACK_IMPORTED_MODULE_0__["ScrollLock"]();
...
/***/ "./js/modules/map/lazy-load-map.js":
/*!*****************************************!*\
  !*** ./js/modules/map/lazy-load-map.js ***!
  \*****************************************/
/*! exports provided: observer, target */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _create_script__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./create-script */ "./js/modules/map/create-script.js");
...
var callback = function callback(entries, observer) {
  entries.forEach(function (entry) {
    ...
    if (!target.classList.contains('is-load')) {
      Object(_create_script__WEBPACK_IMPORTED_MODULE_0__["createScript"])();
    }
  });
};
...
var initMap = function initMap() {
  ...
  var containerImg = container.querySelector('img');
  ...
  function init() {
    ...
    var placemark = new ymaps.Placemark([59.9375603740233, 30.32302094047468], {}, {
...
var initPhoneMask = function initPhoneMask() {
  ...
  var phoneInputs = document.querySelectorAll('[data-form="phone"]');
...
var form = document.querySelectorAll('[data-form="form"]');
...
/*!*********************************!*\
  !*** ./js/utils/remove-nojs.js ***!
  \*********************************/
/*! exports provided: resetDefaultClass */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "resetDefaultClass", function() { return resetDefaultClass; });
var nojsElements = document.querySelectorAll('.no-js');
var resetDefaultClass = function resetDefaultClass() {
